...
8][8]=!a},mapData:function(a,c){for(var b=-1,d=this.moduleCount-1,e=7,f=0,h=this.moduleCount-1;0<h;h-=2)for(6==h&&h--;;){for(var g=0;2>g;g++)if(null==this.modules[d][h-g]){var p=!1;f<a.length&&(p=1==(a[f]>>>e&1));k.getMask(c,d,h-g)&&(p=!p);this.modules[d][h-g]=p;e--; -1==e&&(f++,e=7)}d+=b;if(0>d||this.moduleCount<=d){d-=b;b=-b;break}}}};u.PAD0=236;u.PAD1=17;u.createData=function(a,c,b){c=r.getRSBlocks(a,c);for(var d=new z,e=0;e<b.length;e++){var f=b[e];d.put(f.mode,4);d.put(f.getLength(),k.getLengthInBits(f.mode,
a));f.write(d)}for(e=a=0;e<c.length;e++)a+=c[e].dataCount;if(d.getLengthInBits()>8*a)throw Error("code length overflow. ("+d.getLengthInBits()+">"+8*a+")");for(d.getLengthInBits()+4<=8*a&&d.put(0,4);0!=d.getLengthInBits()%8;)d.putBit(!1);for(;!(d.getLengthInBits()>=8*a);){d.put(u.PAD0,8);if(d.getLengthInBits()>=8*a)break;d.put(u.PAD1,8)}return u.createBytes(d,c)};u.createBytes=function(a,c){for(var b=0,d=0,e=0,f=Array(c.length),h=Array(c.length),g=0;g<c.length;g++){var p=c[g].dataCount,y=c[g].totalCount-
p,d=Math.max(d,p),e=Math.max(e,y);f[g]=Array(p);for(var l=0;l<f[g].length;l++)f[g][l]=255&a.buffer[l+b];b+=p;l=k.getErrorCorrectPolynomial(y);p=(new v(f[g],l.getLength()-1)).mod(l);h[g]=Array(l.getLength()-1);for(l=0;l<h[g].length;l++)y=l+p.getLength()-h[g].length,h[g][l]=0<=y?p.get(y):0}for(l=g=0;l<c.length;l++)g+=c[l].totalCount;a=Array(g);for(l=b=0;l<d;l++)for(g=0;g<c.length;g++)l<f[g].length&&(a[b++]=f[g][l]);for(l=0;l<e;l++)for(g=0;g<c.length;g++)l<h[g].length&&(a[b++]=h[g][l]);return a};for(var q=
...
911,661,511],[1273,997,715,535],[1367,1059,751,593],[1465,1125,805,625],[1528,1190,868,658],[1628,1264,908,698],[1732,1370,982,742],[1840,1452,1030,790],[1952,1538,1112,842],[2068,1628,1168,898],[2188,1722,1228,958],[2303,1809,1283,983],[2431,1911,1351,1051],[2563,1989,1423,1093],[2699,2099,1499,1139],[2809,2213,1579,1219],[2953,2331,1663,1273]],C=function(){var a=function(a,b){this._el=a;this._htOption=b};a.prototype.draw=function(a){function b(a,c){a=document.createElementNS("http://www.w3.org/2000/svg",
...
c=this._elCanvas,d=this._oContext,e=this._htOption,f=a.getModuleCount(),k=e.width/f,m=e.height/f,n=Math.round(k),q=Math.round(m);b.style.display="none";c.style.display="none";this.clear();for(b=0;b<f;b++)for(c=0;c<f;c++){var u=a.isDark(b,c),r=c*k,t=b*m;d.strokeStyle=u?e.colorDark:e.colorLight;d.lineWidth=1;d.fillStyle=u?e.colorDark:e.colorLight;d.fillRect(r,t,k,m);d.strokeRect(Math.floor(r)+.5,Math.floor(t)+.5,n,q);d.strokeRect(Math.ceil(r)-.5,Math.ceil(t)-.5,n,q)}if(this._htOption.img_src&&A){var v=
new Image;v.src=this._htOption.img_src;var w=this._htOption.img_width,x=(this._htOption.width-w)/2;v.onload=function(){d.drawImage(v,x,x,w,w)}}this._bIsPainted=!0};e.prototype.makeImage=function(){this._bIsPainted&&c.call(this,a)};e.prototype.isPainted=function(){return this._bIsPainted};e.prototype.clear=function(){this._oContext.clearRect(0,0,this._elCanvas.width,this._elCanvas.height);this._bIsPainted=!1};e.prototype.round=function(a){return a?Math.floor(1E3*a)/1E3:a};return e}():function(){var a=
function(a,b){this._el=a;this._htOption=b};a.prototype.draw=function(a){for(var b=this._htOption,c=this._el,e=a.getModuleCount(),f=Math.floor(b.width/e),h=Math.floor(b.height/e),g=['<table style="border:0;border-collapse:collapse;">'],k=0;k<e;k++){g.push("<tr>");for(var m=0;m<e;m++)g.push('<td style="border:0;border-collapse:collapse;padding:0;margin:0;width:'+f+"px;height:"+h+"px;background-color:"+(a.isDark(k,m)?b.colorDark:b.colorLight)+';"></td>');g.push("</tr>")}g.push("</table>");c.innerHTML=
g.join("");a=c.childNodes[0];c=(b.width-a.offsetWidth)/2;b=(b.height-a.offsetHeight)/2;0<c&&0<b&&(a.style.margin=b+"px "+c+"px")};a.prototype.clear=function(){this._el.innerHTML=""};return a}();QRCode=function(a,c){this._htOption={width:256,height:256,typeNumber:4,colorDark:"#000000",colorLight:"#ffffff",correctLevel:t.H,img_width:64,img_src:""};"string"===typeof c&&(c={text:c});if(c)for(var b in c)this._htOption[b]=c[b];"string"==typeof a&&(a=document.getElementById(a));this._htOption.useSVG&&(D=
C);this._android=B();this._el=a;this._oQRCode=null;this._oDrawing=new D(this._el,this._htOption);this._htOption.text&&this.makeCode(this._htOption.text)};QRCode.prototype.makeCode=function(a){var c=this._htOption.correctLevel,b=1,d;d=encodeURI(a).toString().replace(/\%[0-9a-fA-F]{2}/g,"a");d=d.length+(d.length!=a?3:0);for(var e=0,f=w.length;e<=f;e++){var h=0;switch(c){case t.L:h=w[e][0];break;case t.M:h=w[e][1];break;case t.Q:h=w[e][2];break;case t.H:h=w[e][3]}if(d<=h)break;else b++}if(b>w.length)throw Error("Too long data");
this._oQRCode=new u(b,this._htOption.correctLevel);this._oQRCode.addData(a);this._oQRCode.make();this._el.title=a;this._oDrawing.draw(this._oQRCode);this.makeImage()};QRCode.prototype.makeImage=function(){"function"==typeof this._oDrawing.makeImage&&(!this._android||3<=this._android)&&this._oDrawing.makeImage()};QRCode.prototype.clear=function(){this._oDrawing.clear()};QRCode.CorrectLevel=t;window.QRCode=QRCode})();
